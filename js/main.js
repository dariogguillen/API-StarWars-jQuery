$(() => {
  ...
  const insertarImg = tituloPelicula => {
    ...
    for (let i = 0; i < length; i++) {
      ...
      } else if (imgPeliculas[i + 1] === tituloPelicula) {
        return imgPeliculas[i + 1]
      } else if (imgPeliculas[i + 2] === tituloPelicula) {
        return imgPeliculas[i + 2]
      } else if (imgPeliculas[i + 3] === tituloPelicula) {
        return imgPeliculas[i + 3]
      } else if (imgPeliculas[i + 4] === tituloPelicula) {
        return imgPeliculas[i + 4]
      } else if (imgPeliculas[i + 5] === tituloPelicula) {
        return imgPeliculas[i + 5]
      } else if (imgPeliculas[i + 6] === tituloPelicula) {
        return imgPeliculas[i + 6]
      } else {
        return 'Star-Wars'
      }
    }
